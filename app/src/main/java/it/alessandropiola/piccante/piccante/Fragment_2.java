 ...
 * {@link Fragment_2.OnFragmentInteractionListener} interface
...
public class Fragment_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button bBuy = (Button) view.findViewById(R.id.buttonMedio);
        bBuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                mHelper.launchPurchaseFlow(getActivity(), "piccante2", 10001,
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener
                                          ...
                                          Purchase purchase)
        {
            ...
            else if (purchase.getSku().equals("piccante2")) {
                //consumeItem();
